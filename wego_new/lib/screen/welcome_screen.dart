...
import 'package:wego_marriage/screen/login_screen.dart';           // ✅ Login Screen import
import 'package:wego_marriage/screen/create_account.dart';         // ✅ Sign Up Screen import
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(              // ✅ Sign Up → create_account.dart
                          context,
                          MaterialPageRoute(
                            builder: (_) => const CreateAccountScreen(),  // 👈 create_account.dart wali screen
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(
...
// ─────────────────────────────────────────────────────────────
// ❌ HATA DIYA — Ye duplicate CreateAccountScreen yahan se remove
//    kar diya gaya hai. Ab create_account.dart wali use hogi.
// ─────────────────────────────────────────────────────────────

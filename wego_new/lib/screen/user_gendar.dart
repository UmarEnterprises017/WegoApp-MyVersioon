...
import 'package:wego_marriage/screen/interested_performance.dart';
...
class _GenderScreenState extends State<GenderScreen> {
  ...
  Future<void> _handleContinue() async {
    ...
    try {
      ...
      // ✅ Step 2: Firestore mein gender save karo
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Gender saved successfully!'),
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => const InterestsScreen(userInfo: {}),
        ),
      );
    } catch (e) {
      if (!mounted) return;
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: primaryRed,
                    disabledBackgroundColor: primaryRed.withValues(alpha: 0.4),
